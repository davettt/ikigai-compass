...
- [ ] Baking and pastry
- [ ] Coffee, tea, wine, or beverage culture
...
- [ ] Building apps, projects, or prototypes
- [ ] Gaming (video games, board games, puzzles)
- [ ] Reading books and articles
- [ ] Audiobooks and podcasts
- [ ] Research and deep dives into topics
...
- [ ] Advocacy and standing up for causes
...
- [ ] Spirituality and philosophical exploration

### Other
*Anything else you love that's not listed above:*
...
- [ ] Quickly learning new tools and software
...
### Economic & Workplace
- [ ] Job creation and meaningful work
...
### Other
*Any other causes or needs you care about:*
...
### Business & Finance
- [ ] Consulting (management, strategy, process)
...
### Other
*Any other careers or paid work you could do:*
...
**Life Context** (circle one):

- **Exploring** - Early career or still discovering my path
- **Transitioning** - Between careers or making a major change
- **Established** - Settled in career, seeking deeper meaning
- **Reinventing** - Mid-career pivot or fresh start
- **Retiring** - Planning for or entering retirement

**Anything else?** *(Optional: any additional context about your situation)*
